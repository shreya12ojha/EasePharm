...
export default function UploadPage() {
  ...
  const enhanceImageForOCR = (canvas: HTMLCanvasElement, ctx: CanvasRenderingContext2D) => {
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Upload prescription image and configure OCR settings</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input id="image" type="file" accept="image/*" onChange={handleFileChange} disabled={isProcessing} />
              </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Review and edit the extracted prescription text</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <Textarea
              ...
              <div className="flex space-x-2">
                <Button onClick={createOrder} disabled={!extractedText} className="flex-1">
                  Create Order
                </Button>
                <Button variant="outline" onClick={() => setExtractedText("")} disabled={!extractedText}>
                  Clear
                </Button>
              </div>
            </CardContent>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="text-sm space-y-1 text-gray-600">
                  <li>• OCR.space API: {process.env.OCR_SPACE_API_KEY ? "✅ Configured" : "❌ Not configured"}</li>
                  <li>• Azure Vision: {process.env.AZURE_VISION_KEY ? "✅ Configured" : "❌ Not configured"}</li>
